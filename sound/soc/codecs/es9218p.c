        ...
        struct snd_ctl_elem_value *ucontrol)
{
     ...
     * However, it isn't necessary to update zero at the reg because the value is updated when plugging a normal/advanced/aux cable.
     * so, return success at right here.
     */
    if( g_avc_volume == 0 )
        return 0;
