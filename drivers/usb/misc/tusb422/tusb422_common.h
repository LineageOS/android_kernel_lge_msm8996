...
// Variadic macro requires "--gcc" compiler switch.
	...
	#define PRINT(str, args...)  pr_debug(PRINT_PREFIX str, ##args)
#else
...
#else
#ifdef CONFIG_LGE_USB_TYPE_C
	#define CRIT(str, args...)  pr_debug(PRINT_PREFIX str, ##args)
#else
...
#else
#ifdef CONFIG_LGE_USB_TYPE_C
	#define DEBUG(str, args...)  pr_debug(PRINT_PREFIX str, ##args)
#else
...
#else
#ifdef CONFIG_LGE_USB_TYPE_C
	#define INFO(str, args...)  pr_debug(PRINT_PREFIX str, ##args)
#else
